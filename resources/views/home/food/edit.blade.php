<x-site-layout>
    ...
    <form class="flex flex-col gap-4" action="{{route('home.food.update', $food->id)}}" method="post">
        ...
        <div>
            ...
            <input type="text" id="name" name="name" placeholder="Food Name" value="{{old('name',$food->name)}}" class="p-1 border @error('name') border-red-600 @else border-sky-700 @enderror">
